-- Lightning Strike Script with Integrated Lock Button & Draggable Toggle Frame
...
local function applyStrikeEffects(char, root)
    ...
    -- 5. Create bright white vertical lightning rod with PointLight illumination for 0.50 seconds
    local bolt = Instance.new("Part")
    bolt.Name = "LightningBolt"
    bolt.Size = Vector3.new(1, 150, 1)
    ...
    -- Remove the bolt and light after 0.50 seconds
    ...
    -- Full effect cleanup & state restore after 2 seconds
